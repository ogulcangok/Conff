   <body>
               ...
               <div class="col-md-12">
                  <div class="section-title title-three text-center">
                     <div class="title-border">
                        <h1>TED <span>Conference</span></h1>
                     </div>
                  </div>
               </div>
            </div>
         ...
         <div class="row" style="margin-top:40px;">
           ...
           <br>
                  ...
                  <div class="panel-body">
                     <div>
                        <ul class="nav nav-tabs" role="tablist">
                           <li role="presentation" class="active"><a href="#personal" aria-controls="personal" role="tab" data-toggle="tab">Kişisel Bilgiler</a></li>
                           <li role="presentation"><a href="#event" aria-controls="event" role="tab" data-toggle="tab">Etkinlik Seç</a></li>
                           <li role="presentation"><a href="#transfer" aria-controls="transfer" role="tab" data-toggle="tab">Transfer | Konaklama | Yemek </a></li>
                           <li role="presentation"><a href="#payment" aria-controls="payment" role="tab" data-toggle="tab">Ödeme</a></li>
                        </ul>
                        <!-- Tab panes -->
                        <div class="tab-content">
                           <div role="tabpanel" class="tab-pane active" id="personal">1</div>
                           <div role="tabpanel" class="tab-pane" id="event">2</div>
                           <div role="tabpanel" class="tab-pane" id="transfer">3</div>
                           <div role="tabpanel" class="tab-pane" id="payment">
                              <p align="center">
                                 <br>
                                 <img src="img/tick.png">
                                 <br><br>
                                 <strong>İŞLEMİNİZ BAŞARIYLA GERÇEKLEŞTİRİLMİŞTİR.</strong>
                                 <br><br>
                                 Online Giriş Kartınızı görmek için <a href="#">tıklayınız.</a>
                                 <br><br>
                              </p>
                              <div class="panel panel-default">
                                 <div class="panel-body">
                                    <p align="center">
                                       KONFERANS ANA SPONSORU TEŞEKKÜR REKLAM ALANI
                                       <br><br>
                                       BLA BLA ANA SPONSORLUĞUNDA
                                       GERÇEKLEŞEN EO TECH KONFERANSINA
                                       KAYIT OLDUĞUNUZ İÇİN TEŞEKKÜR EDER.
                                       (GÖRSEL OLABİLİR BURAS)
                                    </p>
                                 </div>
                              </div>
                           </div>
            ...
            <div class="col-md-3 mt10">
               <div class="panel panel-default">
                  <div class="panel-heading">
                     <h3 class="panel-title">Nerede</h3>
                  </div>
                  <div class="panel-body">
               ...
               <div class="panel panel-default">
                  <div class="panel-heading">
                     <h3 class="panel-title">Nerede & Ne zaman?</h3>
                  </div>
                  <div class="panel-body">
                     <ul id="event-list" style="margin:10px;">
               ...
               <div class="panel panel-default">
                  <div class="panel-heading">
                     <h3 class="panel-title">Önemli Tarihler</h3>
                  </div>
                  <div class="panel-body">
                     <ul id="event-list"style="margin:10px;">
                        <li><a href="#">+ Son Bildiri Tarihi 14.08.2018</a></li>
                        <li><a href="#">+ Yemek Kayıt Tarihi 09.08.2018</a></li>
                        <li><a href="#">+ Tur Kayıt Tarihi 11.09.2018</a></li>
                     </ul>
                     <br> “+” Butonu ile önemli tarihleri takviminize ekleyebilirsiniz.
                  </div>
               </div>
      ...
      <!--Partner Area Start-->
      <div class="partner-area partner-three-area section-padding">
         <div class="container">
            <div class="row">
               <div class="col-md-12">
                  <div class="section-title title-three text-center">
                     <div class="title-border">
                        <h1>Ana <span>Sponsorlar</span></h1>
                     </div>
                  </div>
               </div>
            </div>
      ...
      <!--Footer Area Start-->
      <div class="footer-area footer-three">
         <div class="container">
            <div class="row">
               <div class="col-lg-4 col-md-5 col-sm-12">
                  <span>Copyright © 2018 <a href="#">Conff</a>. All rights reserved.</span>
               </div>
