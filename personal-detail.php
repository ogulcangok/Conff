                              ...
                              <div class="profilemenu">
                                 <nav>
                                    <ul id="nav" class="header-nav">
                                       <li>
                                          <a onclick="dropfunc()" class="dropbtn"><i  class="fa fa-user"></i> PROFİLİM</a>
         ...
         <div class="row" style="margin-top:40px;">
            ...
            <div class="col-md-7 mt10">
               <div class="brdr">
                ...
                <div class="hidden-lg hidden-md col-sm-12">
                  <ul class="mobile-event-details-inner-nav " role="tablist" style="display:block; text-align:center;">
                     <li role="presentation"  class="active" style="margin:10px;">
                       <a href="#personal" aria-controls="personal" onclick="setMainActiveTab('personal')"
                        role="tab" data-toggle="tab" style="color:#444;font-weight: bold;">Kişisel Bilgiler</a></li>
                     ...
                     <li role="presentation"style="margin:10px;">
                       <a href="#transfer" onclick="setMainActiveTab('transfer')" aria-controls="transfer" role="tab"
                  ...
                  <div class="tab-content" style="padding: 20px;">
                     ...
                     <div role="tabpanel" class="tab-pane" id="event">
                        ...
                        <div class="row brdr"
                           ...
                           <div class="col-md-12">
                              <div class="row">
                                 <div class="col-lg-3 col-md-12 col-xs-12" style="display: flex; flex-direction: row; padding: 0;">
                                    <b class="flex-1 text-center brdr-right" style="line-height: 50px;">WORKSHOP 1</b>
                                 </div>
                                 <div class="col-lg-5 col-md-8 col-xs-12 brdr-right" style="display: flex; flex-direction: row; padding: 5px;">
                                   <span class="text-center flex-2" style="font-size: 18px;margin-top:10px; margin-bottom:10px;">12.07.2018 |13.00-15.00 <i class="fa fa-bell-o"></i></span>
                                 </div>
                                 <div class="col-lg-2 col-md-4 col-xs-12" style="display: flex; flex-direction: row; padding: 5px;">
                                    <span class="text-center flex-1" style="font-size: 20px; margin-top:10px;">2000 TL</span>
                                 </div>
                                <div class="col-lg-2 col-md-12 col-xs-12" style="display: flex; flex-direction: row; padding: 0;">
                     ...
                     <div role="tabpanel" class="tab-pane" id="transfer">
                        ...
                        <div class="row" >
                           <div class="row brdr" data-toggle="pinned" style="margin: 10px; color: #444!important;">
                              <div class="col-lg-4 col-md-4 col-sm-4" style="display: flex; line-height: 50px; padding:0;">
                              ...
                              <div class="col-lg-2 col-md-3 col-xs-12" style="display: flex; flex-direction: row; padding: 0;">
                           ...
                           <div class="row no-display" style="padding: 20px; margin:10px; color: #444!important;">
                                 <div class="row brdr" style="background-color: #FFF; margin-bottom: 10px;">
                                    <div class="col-md-6 col-xs-12">
                                       <div class="dropdown flex-1" style="font-size: 14px; line-height: 30px;">
                                          <a id="dLabel4" role="button" data-toggle="dropdown" style="color: #444;" data-target="#" href="#">
                                    ...
                                    <div class="col-md-6 col-xs-12" >
                                       <div class="dropdown flex-1"  style="font-size: 14px; line-height: 30px;">
                                          <a id="dLabel5" role="button" data-toggle="dropdown" style="color: #444;" data-target="#" href="#">
                                 ...
                                 <div class="row brdr "style="background-color: #FFF;">
                                    <div class="col-md-4" >
                                       <div class="dropdown flex-1 text-left" style="font-size: 14px; line-height: 45px; width: 120px;">
                                          <a id="dLabel7" role="button" data-toggle="dropdown" class="color-dark" data-target="#" href="#" >
                     ...
                     <div role="tabpanel" class="tab-pane" id="payment">
                        ...
                        <div class="row" style="margin:10px;">
                           <div class="col-md-12">
                              <form action="/" class="require-validation" id="payment-form" method="post">
                                 ...
                                 <div class="form-row">
                                    <div class="col-md-6" style="padding: 0;">
                                       <div class="form-group card required">
                                          <input autocomplete="off" class="form-control brdr-right brdr-clear-right " size="20"
                                          ...
                                          <ul class="payment-nav-tabs" role="tablist">
                                             <li role="presentation">
                                               <a href="active" href="#creditcard" aria-controls="creditcard"
                                                onclick="setActiveTab('creditcard')" role="tab" data-toggle="tab"
                                                style="padding:15px;">Kredi Kartı </a></li>
                                             <li role="presentation">
                                               <a href="#havale" onclick="setActiveTab('havale')" aria-controls="havale" role="tab"
                                                data-toggle="tab" style="padding:15px;">Havale</a></li>
                                             <li role="presentation">
                                               <a href="#promosyon" onclick="setActiveTab('promosyon')" aria-controls="promosyon" role="tab"
                                             ...
                                             <div class="col-md-6" style="padding: 0;">
                                                <div class="form-group cvc required">
                                                   <input autocomplete="off"
                                                      class="form-control card-cvc brdr-clear-left" placeholder="CVC"
                                                      size="4" type="text">
                                                </div>
                                             </div>
                                          </div>
                              ...
                              <div class="row">
                                 <div class="col-md-8 col-sm-8 col-xs-12" style="display: flex">
                                    <label class="checkbox-container" style="font-size:13px;">TERMS AND CONDITIONAL
                                    <input type="checkbox">
                                    <span class="checkbox-checkmark"></span>
                                    </label>
                                  </div>
                                  <div class="col-md-4 col-sm-4 col-xs-12" style="display: flex">
                                    <button type="submit" class="continue-button  btn-lg btn-block">TAMAMLA</button>
                                 </div>
                              </div>
                              </form>
                           </div>
                     ...
                     <div class="row brdr" style="background-color: #fafafa; padding: 20px; margin:10px; color: #444!important;">
                           <div class="row brdr" style="background-color: #FFF; margin-bottom: 10px;">
                              <div class="col-md-6 col-xs-12">
                                 <div class="dropdown flex-1" style="font-size: 14px; line-height: 30px;">
                                    <a id="dLabel4" role="button" data-toggle="dropdown" style="color: #444;" data-target="#" href="#">
                     ...
                     <div class="row brdr" style="margin: 10px; color: #444!important;">
                         <div class="row" data-toggle="pinned">
                           <div class="col-md-4 col-sm-6 col-xs-12" style="display: flex; flex-direction: row; padding: 0;">
                              <b class="flex-1 text-center" style="line-height: 50px;">OLİMPOS TURU</b>
                           </div>
                               <div class="col-md-5 col-sm-5 hidden-xs" style="display: flex; height: 50px; line-height: 50px; padding:0; flex-direction: row; align-items: stretch; justify-items: center">
            ...
            <div class="brdr btm-mrg-40">
               ...
               <ul class="event-list" style="padding: 10px">
                  ...
                  <br>
                  <br>
                  <li><a href="#" class="red-button  btn-lg btn-block" style="color: #FFF; font-weight: bold;">SEPETE GİT</a></li>
               </ul>
            </div>
